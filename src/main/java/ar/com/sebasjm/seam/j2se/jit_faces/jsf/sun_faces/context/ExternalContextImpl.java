...
package ar.com.sebasjm.seam.j2se.jit_faces.jsf.sun_faces.context;
...
//        return (((HttpServletRequest) request).getSession(create));
    ...
    public String getRequestPathInfo() {
        return (String)request.getAttribute("http_requestPathInfo");
    }
    ...
    public String getRequestContextPath() {
        return (String)request.getAttribute("http_requestContextPath");
    }


    public String getRequestServletPath() {
        return (String)request.getAttribute("http_requestServletPath");
    }
    ...
    public void dispatch(String requestURI) throws IOException, FacesException {
        ...
        if (requestDispatcher == null) {
            log("No se puede despachar", new UnsupportedOperationException("No se puede despachar"));
            return;
        }
        try {
    ...
    public void redirect(String requestURI) throws IOException {
        throw new UnsupportedOperationException("Theres no way to redirect");
